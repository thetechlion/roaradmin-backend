...
import { requireGameKey, requireStaffSession } from "./auth";
import { syncOrgGroup, syncSingleStaffMember } from "./groupSync";
...
// ── Dashboard -> backend ──────────────────────────────────────────────────
// Staff-session-authenticated routes. Real auth wiring (Roblox OAuth) comes
// with the dashboard auth flow; requireStaffSession is a stub for now.
